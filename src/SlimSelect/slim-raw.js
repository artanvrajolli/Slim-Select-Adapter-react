  ...
  return (
    ...
    (s.m = i = [
      function (e, t, i) {
        ...
        (t.__esModule = !0),
          ...
          (t.hasClassInTree = function (e, t) {
            function n(e, t) {
              return t && e && e.classList && e.classList.contains(t)
                ? e
                : null;
            }
            return (
          ...
          (t.highlight = function (e, t, i) {
            ...
            return (n = n.replace(
              s,
              '<mark class="'.concat(i, '">').concat(t, "</mark>")
            ));
          }),
      ...
      function (e, t, i) {
        "use strict";
        (t.__esModule = !0),
          (t.validateOption = t.validateData = t.Data = void 0);
        var n =
              ...
              if ("OPTGROUP" === i.nodeName) {
                for (
                  ...
                  "OPTION" === l.nodeName &&
                    ...
                    o.placeholder &&
                      "" !== o.text.trim() &&
                      (this.main.config.placeholderText = o.text));
                }
                this.data.push(n);
              } else
                "OPTION" === i.nodeName &&
          ...
          (s.prototype.setSelectedFromSelect = function () {
            if (this.main.config.isMultiple) {
              for (
                ...
                var n = i[t];
                !n.selected ||
                  ((n = this.getObjectFromData(n.value, "value")) &&
                    n.id &&
                    e.push(n.id));
              }
          ...
          (s.prototype.getSelected = function () {
            for (
              ...
              if (s.hasOwnProperty("label")) {
                ...
                s.selected &&
                  (this.main.config.isMultiple ? t.push(s) : (e = s));
            }
        ...
        (t.Data = n),
          (t.validateData = function (e) {
            if (!e)
              return console.error("Data must be an array of objects"), !1;
          ...
          i =
            ...
            (l.prototype.selected = function () {
              if (this.config.isMultiple) {
                for (
                  var e = [], t = 0, i = (s = this.data.getSelected());
                  t < i.length;
                  t++
                ) {
                  var n = i[t];
                ...
                (this.data.contentOpen ||
                  ...
                  this.config.isMultiple ||
                    ((e = this.data.getSelected()) &&
                      ((e = e.id),
                      (e = this.slim.list.querySelector(
                        '[data-id="' + e + '"]'
            ...
            (l.prototype.destroy = function (e) {
              var t = (e = void 0 === e ? null : e)
                  ? document.querySelector("." + e + ".ss-main")
                  : this.slim.container,
                i = e
                  ? document.querySelector("[data-ssid=".concat(e, "]"))
                  : this.select.element;
              t &&
                i &&
        ...
        function l(e) {
          ...
          (this.ajax = null),
            ...
            (this.documentClick = function (e) {
              e.target &&
                !(0, o.hasClassInTree)(e.target, t.config.id) &&
                t.close();
            });
      ...
      function (e, t, i) {
        ...
        function s(e) {
          (this.id = ""),
            ...
            e.searchPlaceholder &&
              (this.searchPlaceholder = e.searchPlaceholder),
          ...
          i =
            ...
            (s.prototype.placeholder = function () {
              ...
              null === t || (t && t.placeholder)
                ? ((e = document.createElement("span")).classList.add(
                  ...
                  this.singleSelected &&
                    (this.singleSelected.placeholder.innerHTML = e.outerHTML))
                : ((e = ""),
                  t &&
                    (e =
                      t.innerHTML && !0 !== this.main.config.valuesUseText
                        ...
                        : t.text),
                  this.singleSelected &&
                    (this.singleSelected.placeholder.innerHTML = t ? e : ""));
            }),
            ...
            (s.prototype.values = function () {
              if (this.multiSelected) {
                for (
                  var e = this.multiSelected.values.childNodes,
                    t = this.main.data.getSelected(),
                    i = [],
                    n = 0,
                    s = e;
                ...
                for (
                  var p, e = this.multiSelected.values.childNodes, c = 0;
                  c < t.length;
                  c++
                ) {
                  o = !1;
            ...
            (s.prototype.valueDiv = function (s) {
              ...
              return (
                ...
                (t.innerHTML =
                  s.innerHTML && !0 !== this.main.config.valuesUseText
                    ? s.innerHTML
                    : s.text),
                e.appendChild(t),
                s.mandatory ||
                  ((t = document.createElement("span")).classList.add(
                    this.main.config.valueDelete
                  ),
                  ...
                  (t.onclick = function (e) {
                    ...
                    var t = !1;
                    if (
                      (a.main.beforeOnChange || (t = !0), a.main.beforeOnChange)
                    ) {
                      for (
                        var e = a.main.data.getSelected(),
              ...
              return (
                ...
                (s.onkeyup = function (e) {
                  ...
                  if ("Enter" === e.key) {
                    ...
                    var i = n.list.querySelector(
                      "." + n.main.config.highlighted
                    );
                    i && i.click();
                  } else
                    "ArrowUp" === e.key ||
                    ...
                    n.main.addable &&
                      ...
                      "" !== (e = n.search.input.value).trim()
                        ? ((e = n.main.addable(e)),
                          ...
                          e &&
                            ("object" == typeof e
                              ? (0, o.validateOption)(e) &&
                                (n.main.addData(e), (t = e.value || e.text))
                              : (n.main.addData(
                                  n.main.data.newOption({ text: e, value: e })
                                ),
                                (t = e)),
                            n.main.search(""),
                            setTimeout(function () {
            ...
            (s.prototype.highlightUp = function () {
              ...
              null !==
                (t =
                  t && t.classList.contains(this.main.config.optgroupLabel)
                    ? null
                    : t) ||
                ((i = e.parentNode).classList.contains(
                  this.main.config.optgroup
                ) &&
                  (!i.previousSibling ||
            ...
            (s.prototype.highlightDown = function () {
              ...
              if (t)
                for (
                  i = t.nextSibling;
                  null !== i && i.classList.contains(this.main.config.disabled);
              ...
              null !== i ||
                null === t ||
                ((e = t.parentNode).classList.contains(
                  this.main.config.optgroup
                ) &&
                  e.nextSibling &&
            ...
            (s.prototype.listDiv = function () {
              var e = document.createElement("div");
              return (
                e.classList.add(this.main.config.list),
                      ...
                      r.main.config.selectByGroup &&
                        ...
                        i.addEventListener("click", function (e) {
                          ...
                          for (var t = 0, i = s.children; t < i.length; t++) {
                            var n = i[t];
                            -1 !== n.className.indexOf(a.main.config.option) &&
                              n.click();
                          }
                        }));
                    }
            ...
            (s.prototype.option = function (o) {
              ...
              return (
                (o.disabled || e) &&
                  ((t.onclick = null),
                  r.main.config.allowDeselectOption ||
                    t.classList.add(this.main.config.disabled),
                  r.main.config.hideSelectedOption &&
